    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-sm-5 wow fadeInLeft" data-wow-delay="400ms">
                <div class="image">
                    <img src="images/proinspector.jpg" alt="Xwin" class="img-responsive border-radius">
            ...
            <div class="col-md-7 col-sm-7 shop_info wow fadeInRight" data-wow-delay="400ms">
                ...
                <p class="bottom25">Our ProInspector software advances the department efficiency for issuing and managing building permits, inspections, and reporting.
                    ProInspector collects and organizes all building permit information providing clear status reports for improved decision making and communications
                    to inspectors and the public.</p>
            </div>
        </div>
        <div class="row top25">
            <div class="col-md-12 wow fadeInUp" data-wow-delay="300ms">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h3 class="heading bottom25">Key Benefits<span class="divider-left"></span></h3>
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-responsive table-striped">
                                    ...
                                    <tr>
                                        <td>Real-time activity monitoring</td>
                                    </tr>
                                    <tr>
                                        <td>Cloud based</td>
                                    </tr>
                            ...
                            <div class="col-md-6">
                                <table class="table table-responsive table-striped">
                                    ...
                                    <tr>
                                        <td>Improved departmental access to information</td>
                                    </tr>
                                    <tr>
                                        <td>Clearer, unified communications within the building & other departments</td>
                                    </tr>
                                    <tr>
                                        <td>Simple and easy to use applications</td>
                                    </tr>
                                    <tr>
                                        <td>Advanced analytics for strategic evaluation and planning</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <p>ProwareLabs provides an integrated contact management features to keep you in touch with the people you need, when
                            ...
                            efficiency. Information related to any permit or inspection is instantly available.</p>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h3 class="heading bottom25">Proactive Strategy<span class="divider-left"></span></h3>
                        <p>ProInspector provides the ability to effectively manage multiple active and non-active permits while at the same time
