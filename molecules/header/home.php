    ...
    <div id="rev_slider_video" class="rev_slider"  data-version="5.0">
        <ul>
            ...
            <li data-transition="fade">
                <!-- MAIN IMAGE -->
                <img src="video/Construction.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg">

                <div class="rs-background-video-layer"
                     data-volume="mute"
                     data-videowidth="100%"
                     data-videoheight="100%"
                     data-videomp4="video/Construction.mp4"
                ...
                <div class="tp-caption tp-resizeme"
                     ...
                     data-start="800"><h1><strong>ProInspector</strong><span class="header-subtext"> - Building Department Software</span></h1>
                </div>
                <div class="tp-caption tp-resizeme"
                     data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                     ...
                     data-start="1500"><p>Easy to get started. Simple to master. <br/> Send your reports perfectly every time.</p>
                </div>
                <div class="tp-caption  tp-resizeme"
                     data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
