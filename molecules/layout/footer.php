    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-4 footer_panel bottom25">
                ...
                <a href="index.html" class="footer_logo bottom25"><img src="images/pwl-logo-white.png" alt="ProwareLabs"></a>
                <p>Easy to get started. Simple to master. <br/> Send your reports perfectly every time.</p>
            </div>
            <div class="col-md-4 col-sm-4 footer_panel bottom25">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <p>Copyright &copy; <?= date('Y') ?> ProwareLabs Inc. All rights reserved.</p>
            </div>
        </div>
    </div>
</div>
